...
See `assets/harvest/scripts/gower_distance_utility.py`
...
### Implementation Reference
See `assets/harvest/scripts/principal_component_plotting.py`
...
### Benefits
- Works with any statistic (mean, median, variance, counts).
- No distributional assumptions.
- Provides an "exact" p-value for the specific dataset.
...
To make MAD comparable to standard deviation for normal distributions, it is typically scaled by `1 / 0.6745` (approx 1.4826).
...
### Benefits
- Reduces noise from low-sample levels.
- Groups levels that "behave" similarly relative to the model.
- Essential for geographic or temporal categorical data.

---

## Integration with Data-Pro-Skill

### Recommended Skills to Update
- **stats-causal-inference**: Add permutation test methodology sections.
- **data-analysis-suite**: Add robust scale (MAD) and Gower distance methodologies.
- **marketing-science-metrics**: Use Gower distance for customer segmentations.
