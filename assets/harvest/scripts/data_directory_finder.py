"""
Data Directory Finder

Automatically locate the data directory in a project hierarchy by searching upward
from the current file location.

Source: Practical Statistics for Data Scientists, common.py
"""
