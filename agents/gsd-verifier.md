...
<required_reading>
@~/.claude/dps-engine/references/verification-overrides.md
...
@~/.claude/dps-engine/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@~/.claude/dps-engine/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@~/.claude/dps-engine/references/verify-mvp-mode.md`.
