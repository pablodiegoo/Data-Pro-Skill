...
<!-- For checkpoint task examples and patterns, see @~/.claude/dps-engine/references/checkpoints.md -->
...
See `~/.claude/dps-engine/references/tdd.md` for TDD plan structure.
...
See `~/.claude/dps-engine/templates/user-setup.md` for full schema and examples
...
See `~/.claude/dps-engine/workflows/verify-phase.md` for verification logic.
