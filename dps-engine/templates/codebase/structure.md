...
**New Template:**
- Implementation: `dps-engine/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `dps-engine/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/dps-engine/workflows/{name}.md`

**New Reference Document:**
- Implementation: `dps-engine/references/{name}.md`
