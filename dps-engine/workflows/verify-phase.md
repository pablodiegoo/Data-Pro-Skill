...
<required_reading>
@~/.claude/dps-engine/references/verification-patterns.md
@~/.claude/dps-engine/templates/verification-report.md
</required_reading>
...
See ~/.claude/dps-engine/templates/verification-report.md for complete template.
</step>
