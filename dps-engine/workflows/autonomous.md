...
> Full instructions are in `dps-engine/references/autonomous-smart-discuss.md`. Read that file now and follow it exactly.
...
Read and execute: `$HOME/.claude/dps-engine/references/autonomous-smart-discuss.md`
