...
<required_reading>
@~/.claude/dps-engine/references/user-story-template.md
@~/.claude/dps-engine/references/spidr-splitting.md
@~/.claude/dps-engine/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@~/.claude/dps-engine/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@~/.claude/dps-engine/references/user-story-template.md`:
...
Run the SPIDR rules from `@~/.claude/dps-engine/references/spidr-splitting.md`. Briefly:
