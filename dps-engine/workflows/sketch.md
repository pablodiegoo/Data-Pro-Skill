...
@~/.claude/dps-engine/references/sketch-theme-system.md
@~/.claude/dps-engine/references/sketch-variant-patterns.md
@~/.claude/dps-engine/references/sketch-interactivity.md
@~/.claude/dps-engine/references/sketch-tooling.md
</required_reading>
