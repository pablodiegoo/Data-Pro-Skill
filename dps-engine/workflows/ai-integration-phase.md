...
<required_reading>
@~/.claude/dps-engine/references/ai-frameworks.md
@~/.claude/dps-engine/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp "$HOME/.claude/dps-engine/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
