...
Key references:
- @$HOME/.claude/dps-engine/references/ui-brand.md (display patterns)
- @$HOME/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.claude/dps-engine/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/.claude/dps-engine/USER-PROFILE.md"
...
```bash
cp "$HOME/.claude/dps-engine/USER-PROFILE.md" "$HOME/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.claude/dps-engine/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.claude/dps-engine/references/user-profiling.md`
...
Reference: @$HOME/.claude/dps-engine/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.claude/dps-engine/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.claude/dps-engine/USER-PROFILE.md" and jump to step 10.
...
Your profile:    $HOME/.claude/dps-engine/USER-PROFILE.md
```
