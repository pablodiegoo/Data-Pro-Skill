...
<template>
@~/.claude/dps-engine/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@~/.claude/dps-engine/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `~/.claude/dps-engine/workflows/transition.md`.
...
- Follow @~/.claude/dps-engine/workflows/diagnose-issues.md
